                                    ...
                                    <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <textarea name="about" class="form-control" cols="10" rows="5">{{ Auth::user()->about }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <form action="{{ route('admin.password.update') }}" method="POST" class="form-horizontal">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="password" id="confirm_password" name="password_confirmation" class="form-control" placeholder="Enter your new password again">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
