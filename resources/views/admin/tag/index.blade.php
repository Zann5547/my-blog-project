                                    ...
                                    @foreach ($tags as $key=>$tag)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.tag.edit', $tag) }}" class="btn btn-info waves-effect"><i class="material-icons">edit</i></a>
                                                <button class="btn btn-danger waves-effect" type="button" onclick="deleteTag({{ $tag->id }})"><i class="material-icons">delete</i></button>
                                                <form id="delete-form-{{ $tag->id }}" action="{{ route('admin.tag.destroy', $tag) }}" method="POST" style="display: none">
                                                    @method('DELETE')
                                                    @csrf
                                                </form>
                                            </td>
