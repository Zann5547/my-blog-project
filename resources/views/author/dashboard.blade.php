            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ Auth::user()->favorate_posts()->count() }}" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <tbody>
                                    @foreach ($popular_posts as $key=>$post)
                                        <tr>
                                            ...
                                            <td>{{ $post->favorate_to_users_count }}</td>
